...
const projects: Project[] = [
  ...
  { name: 'RouteBuilder (RunBuilder v2)', emoji: '🛣️', slug: 'routebuilder', status: 'Active', description: 'React 19 + .NET 9 rebuild of RunBuilder — parallel with legacy, app-layer over SPs, surfaces tucJob + tucJobBooking (Kevin)', repo: 'https://github.com/Deliver-Different-Testing/runbuilder', docs: 'https://github.com/Deliver-Different-Testing/runbuilder/blob/master/docs/STEVE-RUNBUILDER-V2-SCOPING-2026-06-13.md' },
]

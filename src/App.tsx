...
const projects: Project[] = [
  ...
  { name: 'App Configurator', emoji: '🔧', slug: 'app-configurator', status: 'Active', description: 'Admin Manager with Automation Engine — 7 modules, 36K lines', live: 'https://deliver-different-testing.github.io/App-Configurator/', repo: 'https://github.com/Deliver-Different-Testing/App-Configurator' },
